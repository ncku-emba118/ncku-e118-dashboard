...
const HELP: Record<string, HelpEntry> = {
  ...
  reports: {
    ...
    steps: [
      ...
      '上台報告時：打開任一份 PDF，按「用簡報模式播放」，教室電腦全螢幕投影、手機掃 QR 就能當遙控器翻頁',
    ],
  },
  thesis: {
    title: '論文查詢系統',
  ...
  activities: {
    ...
    desc: '用同一個入口整理迎新與聚會、職業參訪、節慶活動及後續班級出遊，搭配活動照片與完整紀錄。',
    steps: [
      '首頁可用分類按鈕查看迎新／聚會、職業參訪、節慶活動與班級出遊',
      '活動依日期排序，最新紀錄優先顯示',
      '點活動卡片可查看活動摘要與 Google 雲端硬碟照片',
      '職業參訪卡片會連到完整的企業介紹與現場紀錄',
      '新活動資料夾同步後，網站會自動加入活動卡片',
    ],
  },
  leads: {
    title: '各活動總召',
