...
const SMALL = ['finance', 'drive', 'thesis', 'reports', 'credits', 'clubs', 'activities'];
const OFFICER_SVG =
        ...
        <div className="container top-inner">
          <a href="#" className="brand">
            ...
            <div className="brand-class">
              ...
              <span className="brand-class-label">Class Portal</span>
            </div>
          </a>
      ...
      <main>
        <div className="container">
          <section className="bx-hero">
            ...
            <h1 className="bx-hero-h1">E118 班級入口</h1>
            <p className="bx-hero-lede">課程、班務與活動紀錄，一頁快速找到。行事曆與班級公告會持續更新。</p>
          </section>
          ...
          <section id="apps" className="bx-wrap">
            <div className="bx-grid">
              ...
              <a className="bx-tile bx-lg bx-feedcal" href={cal.href} {...(cal.localHref ? { 'data-local-href': cal.localHref } : {})}>
                ...
                <div className="bx-feedfoot">完整行事曆</div>
              </a>
              ...
              <div className="bx-tile bx-lg bx-feed">
                ...
                <a className="bx-feedfoot" href={board.href}>全部公告</a>
              </div>
              ...
              <a className="bx-tile bx-gold" href="/officers">
                ...
                <div className="bx-meta">南班／北班組織圖</div>
              </a>
      ...
      <footer className="foot">
        <div className="container foot-inner">
          <div className="foot-left">
            <div className="foot-mark">國立成功大學 EMBA <span className="wine">·</span> E118 Class Portal</div>
